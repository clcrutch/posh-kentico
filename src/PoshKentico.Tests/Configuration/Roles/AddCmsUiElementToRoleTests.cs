// <copyright file="AddCmsUiElementToRoleTests.cs" company="Chris Crutchfield">
...
namespace PoshKentico.Tests.Configuration.Roles
{
    ...
    [TestFixture]
    public class AddCmsUiElementToRoleTests
    {
        [Test]
        public void AddCmsUiElementToRoleTest()
        {
            var roleServiceMock = new Mock<IRoleService>();

            var businessLayer = new AddCmsUIElementToRoleBusiness
            {
            ...
            businessLayer.AddUiElementToRole(roleMock1.Object, resourceName, elementName);

            roleServiceMock.Verify(x => x.GetUiElement(resourceName, elementName));

            roleServiceMock.Verify(x => x.AddUiElementToRole(It.IsAny<IUIElement>(), roleMock1.Object));
        }
    }
}

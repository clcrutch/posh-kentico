// <copyright file="RemoveCmsUiElementFromRoleCmdlet.cs" company="Chris Crutchfield">
...
namespace PoshKentico.Cmdlets.Configuration.Roles
{
    ...
    [Cmdlet(VerbsCommon.Remove, "CmsUiElementFromRole")]
    [Alias("refromrole")]
    public class RemoveCmsUIElementFromRoleCmdlet : GetCmsRoleCmdlet
    {
        #region Constants
        ...
        /// </summary>
        [Import]
        public RemoveCmsUIElementFromRoleBusiness RemoveBusinessLayer { get; set; }
        #endregion
        ...
        protected override void ActOnObject(IRole role)
        {
            ...
            this.RemoveBusinessLayer.RemoveUiElementFromRole(role, this.ResourceName, this.ElementName);
        }
        #endregion
    }
}

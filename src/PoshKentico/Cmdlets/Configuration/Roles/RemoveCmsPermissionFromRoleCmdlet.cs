// <copyright file="RemoveCmsPermissionFromRoleCmdlet.cs" company="Chris Crutchfield">
...
namespace PoshKentico.Cmdlets.Configuration.Roles
{
    ...
    [Cmdlet(VerbsCommon.Remove, "CmsPermissionFromRole")]
    [Alias("aptorole")]
    public class RemoveCmsPermissionFromRoleCmdlet : GetCmsRoleCmdlet
    {
        #region Constants

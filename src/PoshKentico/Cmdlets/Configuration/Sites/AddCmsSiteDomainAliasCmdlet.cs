...
namespace PoshKentico.Cmdlets.Configuration.Sites
{
    ...
    ///     <code>Add-CMSSiteDomainAlias -SiteName "*bas*" -AliasName "cul"</code>
    /// </example>
    /// <example>
    ...
    ///     <code>Add-CMSSiteDomainAlias -SiteName "basic" -EXACT -AliasName "cul"</code>
    /// </example>
    /// <example>
    ///     <para>Add a culture with culture code "cul" to a site.</para>
    ///     <code>$site | Add-CMSSiteDomainAlias -AliasName "cul"</code>
    /// </example>
    /// <example>
    ///     <para>Add a culture with culture code "cul" with the specified site IDs.</para>
    ///     <code>Add-CMSSiteDomainAlias -ID 1,2,3 -AliasName "cul"</code>
    /// </example>
    /// </summary>
    ...
    public class AddCmsSiteDomainAliasCmdlet : MefCmdlet
    {
        ...
        /// </summary>
        [Import]
        public AddCmsSiteDomainAliasBusiness BusinessLayer { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                case OBJECTSET:
                    this.BusinessLayer.AddDomainAlias(this.SiteToAdd.ActLike<ISite>(), this.AliasName);
                    break;
                case SITENAMESET:
                    this.BusinessLayer.AddDomainAlias(this.SiteName, this.Exact.ToBool(), this.AliasName);
                    break;
                case IDSETNAME:
                    this.BusinessLayer.AddDomainAlias(this.ID, this.AliasName);
                    break;
            }
        }

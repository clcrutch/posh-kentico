// <copyright file="NewCmsMediaLibraryFolderBusiness.cs" company="Chris Crutchfield">
...
namespace PoshKentico.Business.ContentManagement.MediaLibraries
{
    ...
    /// </summary>
    [Export(typeof(NewCmsMediaLibraryFolderBusiness))]
    public class NewCmsMediaLibraryFolderBusiness : CmdletBusinessBase
    {
        #region Properties
        ...
        {
            this.MediaLibraryService.CreateMediaLibraryFolder(siteID, name, folder);
        }

// <copyright file="RemoveCmsUserFromSiteBusiness.cs" company="Chris Crutchfield">
...
namespace PoshKentico.Business.Configuration.Users
{
    ...
    /// </summary>
    [Export(typeof(RemoveCmsUserFromSiteBusiness))]
    public class RemoveCmsUserFromSiteBusiness : CmdletBusinessBase
    {
        #region Properties
        ...
        /// <summary>
        /// Removes a user <see cref="IUser"/> frpm the specified site<see cref="ISite"/> in the CMS System.
        /// </summary>
        ...
        {
            this.UserService.RemoveUserFromSite(user, siteName);
        }

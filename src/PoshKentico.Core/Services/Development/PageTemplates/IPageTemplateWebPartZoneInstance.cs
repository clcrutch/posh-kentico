// <copyright file="IPageTemplateWebPartZoneInstance.cs" company="Chris Crutchfield">
...
namespace PoshKentico.Core.Services.Development.PageTemplates
{
    ...
    /// </summary>
    public interface IPageTemplateWebPartZoneInstance
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="IPageTemplate"/> associated with the <see cref="IPageTemplateField"/>.
        /// </summary>
